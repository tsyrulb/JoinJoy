...
namespace JoinJoy.Infrastructure.Migrations
{
    ...
    [Migration("20240527152516_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JoinJoy.Core.Models.ActivityPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JoinJoy.Core.Models.Hobby", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JoinJoy.Core.Models.Interest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JoinJoy.Core.Models.UserActivityPreference", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");

                    b.Property<int>("ActivityPreferenceId")
                        .HasColumnType("int");

                    b.Property<int>("Weight")
                        .HasColumnType("int");

                    b.HasKey("UserId", "ActivityPreferenceId");

                    b.HasIndex("ActivityPreferenceId");
            ...
            modelBuilder.Entity("JoinJoy.Core.Models.UserHobby", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JoinJoy.Core.Models.UserInterest", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JoinJoy.Core.Models.Activity", b =>
                {
                    ...
                    b.HasOne("JoinJoy.Core.Models.Location", null)
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("JoinJoy.Core.Models.UserActivityPreference", b =>
                {
                    b.HasOne("JoinJoy.Core.Models.ActivityPreference", "ActivityPreference")
                        .WithMany("UserActivityPreferences")
                        .HasForeignKey("ActivityPreferenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ActivityPreference");
            ...
            modelBuilder.Entity("JoinJoy.Core.Models.UserHobby", b =>
                {
                    b.HasOne("JoinJoy.Core.Models.Hobby", "Hobby")
            ...
            modelBuilder.Entity("JoinJoy.Core.Models.UserInterest", b =>
                {
                    b.HasOne("JoinJoy.Core.Models.Interest", "Interest")
            ...
            modelBuilder.Entity("JoinJoy.Core.Models.ActivityPreference", b =>
                {
                    b.Navigation("UserActivityPreferences");
                });
